...
//  wd.findElement(By.cssSelector(String.format("a[href='edit?id='%s']",id))).click();
  ...
  public Contacts all() {
    ...
    for (WebElement row : rows) {
      ...
      ContactData contact = new ContactData().withId(id).withFirstName(firstname).withLastName(lastname)
              .withPhone1(phones[0]).withPhone2(phones[1]).withPhone3(phones[2]);
  ...
  public ContactData infoFromEditForm(ContactData contact) {
    ...
    wd.navigate().back();
    return new ContactData().withFirstName(firstname).withLastName(lastname).withPhone1(home).
            withPhone2(mobile).withPhone3(work);
